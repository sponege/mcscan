  ...
  function onEncryptionKeyRequest(packet) {
    ...
    function gotSharedSecret(err, sharedSecret) {
      ...
      if (options.haveCredentials) {
        ...
        if (packet.serverId !== "-") {
          debug(
            "This server appears to be an online server and you are providing no password, the authentication will probably fail"
          );
        }
      ...
      function sendEncryptionKeyResponse() {
        const mcData = require("minecraft-data")(
          client.version == "1.21" ? "1.20.4" : client.version
        );
